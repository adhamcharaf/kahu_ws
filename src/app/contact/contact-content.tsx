...
// ============================================================================
// Contact Content - Version animee Apple-style
// ============================================================================
      ...
      <section className="relative py-section bg-kahu-cream-deep overflow-hidden">
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            <CinematicHeader
              title="Contact"
              subtitle="Une question, un projet, une envie ? N'hesitez pas a nous contacter. Nous serons ravis d'echanger avec vous."
            />
          </div>
        </div>
      </section>
