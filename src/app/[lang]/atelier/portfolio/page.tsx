        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 mb-8">
          <SectionReveal>
            <h2 className="font-display text-display-md text-kahu-charcoal mb-2">
              {lang === "fr" ? "Creations" : "Creations"}
            </h2>
            <p className="text-body-md text-kahu-taupe">
              {lang === "fr"
                ? "Notre selection de mobilier artisanal"
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center">
          <SectionReveal>
            ...
            <p className="text-body-md text-kahu-taupe max-w-2xl mx-auto mb-8">
              {lang === "fr"
                ? "Decouvrez nos projets d'amenagement et de renovation dans la section Espace."
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center">
          <SectionReveal>
            <h2 className="font-display text-display-md text-kahu-charcoal mb-4">
              {lang === "fr" ? "Votre projet en tete ?" : "Have a project in mind?"}
            </h2>
            <p className="text-body-md text-kahu-taupe max-w-xl mx-auto mb-8">
              {lang === "fr"
                ? "Chaque creation commence par une conversation. Partagez-nous votre vision."
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              >
                {lang === "fr" ? "Decouvrir le sur-mesure" : "Discover bespoke"}
                <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                  <path strokeLinecap="round" strokeLinejoin="round" d="M13.5 4.5L21 12m0 0l-7.5 7.5M21 12H3" />
                </svg>
              </a>
